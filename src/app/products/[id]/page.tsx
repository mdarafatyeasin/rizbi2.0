    ...
    setOrderForm((prev) => ({
      ...
      [name]:
        name === "quantity"
          ? Math.max(
              1,
              Math.min(Number.parseInt(value, 10) || 1, product.stock)
            )
          : value,
    }));
  };
      ...
      <Dialog open={isOrderDialogOpen} onOpenChange={setIsOrderDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Please fill in your details to place the order for {product.name}.
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <div className="col-span-3 font-semibold">
                ${(product.price * orderForm.quantity).toFixed(2)}
              </div>
            </div>
          </div>
          <DialogFooter>
